      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto w-full space-y-6 flex-1 overflow-y-auto">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="ft-mono text-xs text-zinc-500">
        ...
        <div className="relative">
          <input
            ...
            className="w-full text-xs p-2.5 pl-8 rounded-lg outline-none bg-white border border-zinc-300"
          />
          <svg
            className="w-4 h-4 text-zinc-400 absolute left-2.5 top-3"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div className="space-y-2.5">
          {itemsFiltrados.length === 0 ? (
            ...
            >
              <p className="ft-body text-xs text-zinc-500">
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-start gap-2.5 min-w-0">
                      <span className="ft-display text-xs font-bold w-6 h-6 rounded-full bg-zinc-200 text-zinc-800 flex items-center justify-center shrink-0 mt-0.5">
                        {i + 1}
                      </span>
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5">
                          <p className="ft-body font-bold text-sm truncate text-zinc-900">
                            {a.local.nombre}
                          </p>
                          <span className="ft-body text-[11px] text-zinc-500 truncate">
                            · {a.local.cliente.nombre}
                          </span>
                        </div>
                        <p className="ft-body text-xs text-zinc-500 truncate mt-0.5">
                  ...
                  >
                    <div className="flex items-center gap-3 text-[11px] text-zinc-500">
                      ...
                      {ultimaVisita?.entrada && (
                        <span className="ft-mono font-medium text-zinc-800">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-1 rounded text-zinc-600 hover:text-black border border-zinc-300 hover:bg-zinc-100 transition cursor-pointer"
                        title="Ver mapa"
                      >
        ...
        >
          {novedadExito ? (
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 mb-1">Tipo de Novedad:</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-zinc-700 mb-1">Asunto / Título:</label>
                <input
                  type="text"
                  value={tituloNovedad}
        ...
        {!gps && !obteniendo && (
          <div>
            ...
            <input
              ...
              className="w-full text-xs p-2 rounded-md border border-zinc-300"
            />
          </div>
        )}
