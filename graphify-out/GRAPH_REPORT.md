# Graph Report - COMERCIA  (2026-09-18)

## Corpus Check
- 454 files · ~170,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2426 nodes · 4570 edges · 354 communities (162 shown, 192 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3dd8477`
...
- 3. Server-Side Performance
- 20260917000000_modulo_comercial_novedades_avisos_supervision/migration.sql
...
- 20260911153000_integracion_ucheck/migration.sql
...
- 20260706131806_roles_visibilidad_y_locales/migration.sql
...
- 20260715213000_agrega_titulo_tareas/migration.sql
- exclude
- 20260730120000_cache_ruta_diaria_precision_gps/migration.sql
...
3. `CampoController` - 60 edges
4. `apiFetch()` - 56 edges
5. `ConsultaCampoDto` - 44 edges
6. `respuestaPaginada` - 33 edges
7. `rangoPaginacion()` - 33 edges
8. `NotificacionService` - 26 edges
9. `PaginacionDto` - 26 edges
10. `ListarUsuariosDto` - 24 edges

## Surprising Connections (you probably didn't know these)
- `AvisosPanel()` --calls--> `apiFetch()`  [EXTRACTED]
  apps/web/src/components/campo/avisos-panel.tsx → apps/web/src/lib/api.ts
...
- `NovedadesPanel()` --calls--> `apiFetch()`  [EXTRACTED]
  apps/web/src/components/campo/novedades-panel.tsx → apps/web/src/lib/api.ts
...
Cohesion: 0.15
Nodes (13): RequestConUsuario, CampoController, Body, Controller, Delete, Param, Post, Req (+5 more)
...
Cohesion: 0.17
Nodes (4): CampoAccesoService, Injectable, PrismaService, Injectable
...
Cohesion: 0.18
Nodes (21): ClientesPanel(), AgendaDelDia(), TareasDeLocal(), LocalesPanel(), AsignacionesLocal(), HorariosLocal(), ModalBackups(), PlanLocal() (+13 more)

### Community 9 - "tareas-impulsador-panel.tsx"
Cohesion: 0.12
Nodes (22): BotonesFormulario(), CabeceraCampo(), CampoTexto(), JornadaPanel(), ListadoVisitas(), ModalMarca(), VisitasPanel(), TareasImpulsadorPanel() (+14 more)
...
### Community 11 - "NotificacionService"
Cohesion: 0.11
Nodes (10): ContadorNoLeidasDto, MarcarTodasLeidasDto, NotificacionDto, AvisoService, Injectable, NotificacionService, Injectable, NovedadService (+2 more)
...
Cohesion: 0.10
Nodes (34): SelectorUbicacion, MapaClientes(), MapaClientesProps, MapaLocal(), Props, SelectorClienteCombobox(), SelectorUbicacion(), CATEGORIAS_PRESET (+26 more)
...
Cohesion: 0.07
Nodes (33): Tab, EmpresasAbmPanel(), FORM_INICIAL, FormEmpresa, ModulosPanel(), FORM_INICIAL, RolesPanel(), NovedadesPanel() (+25 more)
...
### Community 25 - "usuarios.service.ts"
Cohesion: 0.06
Nodes (48): AdminUsuariosController, ApiTags, Body, Controller, Delete, Get, Param, Patch (+40 more)
...
### Community 30 - "campo.ts"
Cohesion: 0.08
Nodes (43): AvisosPanel(), AvisosPanelProps, BadgeNotificaciones(), formatearHoraOFecha(), obtenerGrupoFecha(), PanelNotificaciones(), PanelNotificacionesProps, PanelComentarios() (+35 more)

### Community 31 - "toast-provider.tsx"
Cohesion: 0.13
...
### Community 36 - "foto.service.ts"
Cohesion: 0.10
Nodes (21): ComentarioTareaDto, CrearComentarioTareaDto, IsNotEmpty, IsString, MaxLength, FotosTareaResponseDto, FotoTareaDto, MomentoFotoDto (+13 more)
...
### Community 38 - "PaginacionDto"
Cohesion: 0.20
Nodes (9): PaginacionDto, IsInt, IsOptional, Max, Min, Type, ApiOperation, Get (+1 more)
...
Cohesion: 0.14
Nodes (11): MENSAJES_DUPLICADO, LoginSimDto, ArrayMaxSize, IsArray, IsString, MaxLength, Transform, AsignacionUsuario (+3 more)

### Community 42 - "plataforma.controller.ts"
Cohesion: 0.16
Nodes (8): JwtAuthGuard, Injectable, SuperadminGuard, Injectable, EmpresasController, ApiTags, Controller, UseGuards

### Community 43 - "CrearNovedadDto"
Cohesion: 0.30
Nodes (11): ActualizarEstadoNovedadDto, CrearNovedadDto, ListarNovedadesDto, IsEnum, IsInt, IsOptional, IsString, MaxLength (+3 more)

### Community 44 - "7. JavaScript Performance"
Cohesion: 0.13
...
### Community 46 - "ConsultaCampoDto"
Cohesion: 0.19
Nodes (5): Get, Query, ConsultaCampoDto, rangoPaginacion(), respuestaPaginada

### Community 47 - "panel/layout.tsx"
Cohesion: 0.09
Nodes (18): AdminPage(), PanelLayout(), PaginaModulo(), PanelInicioPage(), AuthShell(), BrandMark(), BotonTema(), LoginForm() (+10 more)
...
### Community 53 - "acceso-plataforma.service.ts"
Cohesion: 0.16
...
### Community 60 - "jornada-campo.service.ts"
Cohesion: 0.15
Nodes (15): prisma, FilaAgendaId, ReglaHorario, TotalAgenda, JornadaCampoService, Injectable, condicionAgenda(), fechaCampo() (+7 more)

### Community 61 - "Reglas de UI/UX de Comercia (OBLIGATORIAS — aplicarlas en TODO lo que se construya)"
Cohesion: 0.14
...
### Community 62 - "supervision.service.ts"
Cohesion: 0.23
Nodes (9): ColaboradorResumenItem, ConsultaSupervisionDto, SupervisionResumenDto, IsDateString, IsOptional, Matches, SupervisionService, Injectable (+1 more)

### Community 63 - "Flujo diario de trabajo"
Cohesion: 0.15
...
### Community 66 - "Servicios en el servidor: dónde están y cómo verlos"
Cohesion: 0.17
...
### Community 67 - "Checklist de configuración — local y producción"
Cohesion: 0.17
...
### Community 68 - "3. Server-Side Performance"
Cohesion: 0.18
...
### Community 70 - "20260917000000_modulo_comercial_novedades_avisos_supervision/migration.sql"
Cohesion: 0.60
Nodes (4): "campo_aviso_lecturas", "campo_avisos", "campo_novedades", "campo_tareas"

### Community 71 - "React Best Practices"
Cohesion: 0.20
...
### Community 73 - "api/README.md"
Cohesion: 0.20
Nodes (9): Compile and run the project, Deployment, Description, License, Project setup, Resources, Run tests, Stay in touch (+1 more)

### Community 74 - "React Best Practices"
Cohesion: 0.20
Nodes (9): 4.1 Deduplicate Global Event Listeners, 4.2 Use Passive Event Listeners for Scrolling Performance, 4.3 Use SWR for Automatic Deduplication, 4.4 Version and Minimize localStorage Data, 4. Client-Side Data Fetching, Abstract, React Best Practices, References (+1 more)

### Community 75 - "Sections"
Cohesion: 0.20
Nodes (9): 1. Eliminating Waterfalls (async), 2. Bundle Size Optimization (bundle), 3. Server-Side Performance (server), 4. Client-Side Data Fetching (client), 5. Re-render Optimization (rerender), 6. Rendering Performance (rendering), 7. JavaScript Performance (js), 8. Advanced Patterns (advanced) (+1 more)

### Community 76 - "Despliegue de Comercia en un servidor Linux"
Cohesion: 0.20
...
### Community 80 - "20260814193000_refactor_tareas_canonicas/migration.sql"
Cohesion: 0.25
...
### Community 81 - "20260708180426_territorios_zonas_checklists_visitas/migration.sql"
Cohesion: 0.46
Nodes (7): "config_impulsador", "locales", "tareas_local", "territorios", "visita_tareas", "visitas", "zonas"

### Community 82 - "20260715150000_clientes_tareas_globales_y_asignaciones/migration.sql"
Cohesion: 0.32
...
### Community 88 - "campo.controller.ts"
Cohesion: 0.14
Nodes (33): AsignacionCampoDto, BackupCampoDto, ClienteCampoDto, EntradaCampoDto, HorarioCampoDto, LocalCampoDto, MarcaCampoDto, TareaCampoDto (+25 more)
...
### Community 90 - "1. Eliminating Waterfalls"
Cohesion: 0.29
Nodes (7): 1.1 Check Cheap Conditions Before Async Flags, 1.2 Defer Await Until Needed, 1.3 Dependency-Based Parallelization, 1.4 Prevent Waterfall Chains in API Routes, 1.5 Promise.all() for Independent Operations, 1.6 Strategic Suspense Boundaries, 1. Eliminating Waterfalls
...
### Community 100 - ""usuarios""
Cohesion: 0.90
Nodes (4): "conexiones", "empresas", "roles", "usuarios"

### Community 101 - "Comercia Fullstack Best Practices"
Cohesion: 0.40
Nodes (4): Backend, Comercia Fullstack Best Practices, Frontend, Verification

### Community 102 - "8. Advanced Patterns"
Cohesion: 0.40
Nodes (5): 8.1 Do Not Put Effect Events in Dependency Arrays, 8.2 Initialize App Once, Not Per Mount, 8.3 Store Event Handlers in Refs, 8.4 useEffectEvent for Stable Callback Refs, 8. Advanced Patterns

### Community 103 - "Comercia Fullstack Best Practices"
Cohesion: 0.40
Nodes (4): Backend, Comercia Fullstack Best Practices, Frontend, Verification

### Community 107 - "Automatización del servidor: cron, fail2ban y unattended-upgrades"
Cohesion: 0.40
...
### Community 115 - "Q: que significa programacion pausada y como reanudar"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: que significa programacion pausada y como reanudar, Source Nodes

### Community 119 - "Q: cuales son las librerias que usa para el calculo de ruta"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: cuales son las librerias que usa para el calculo de ruta, Source Nodes

### Community 120 - "Q: en que tabla puedo ver que se guarda los datos de la ubi etc del usuario? ademas quiero que se envie la ubi cada 1min etc de los usuarios"
Cohesion: 0.40
...
### Community 121 - "Q: el back en api.comercia.pro funciona, hice un login y funciono https://api.comercia.pro/api/v1/auth/login"
Cohesion: 0.40
...
### Community 126 - "Q: Qué significan precision_metros, registrada_en y recibida_en en ubicaciones_usuario"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Qué significan precision_metros, registrada_en y recibida_en en ubicaciones_usuario, Source Nodes

### Community 129 - "Q: El número viejo de celular quedó guardado en la sesión y quiero que no vuelva a pasar"
Cohesion: 0.40
...
### Community 130 - "Q: como se llama el store que usa cuando no hay conexion y guarda en el celular, y se borra una vez que se envia al servidor"
Cohesion: 0.40
...
### Community 131 - "Q: Arquitectura existente para roles Team Leader/Impulsador, asignación de locales, tareas dirigidas, visitas, rendimiento y notificaciones móviles"
Cohesion: 0.40
...
### Community 132 - "Q: ya no me funciona bien el apk cuando inicio la app nunca mas esta reconociendo las sim's para traer los nros de telefono e iniciar automaticamente el login, corregir eso"
Cohesion: 0.40
...
### Community 133 - "Q: En producción el login da CORS y el front dice No se pudo conectar con el servidor; verificar qué pasa"
Cohesion: 0.40
...
### Community 134 - "Q: ¿Cómo quedó conectado el home del panel con el resumen de presentismo operativo y sus rutas de detalle?"
Cohesion: 0.40
...
### Community 135 - "Q: Como quitar todas las tareas solamente de un usuario respetando la jerarquia"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Como quitar todas las tareas solamente de un usuario respetando la jerarquia, Source Nodes

### Community 136 - "Q: migration.sql se ejecuta automaticamente cuando hago el commit o yo tengo que hacerlo?"
Cohesion: 0.40
...
### Community 137 - "Q: Como refactorizar las tablas de tarea según alcance global, por equipo, usuario, cliente/local e historial de visitas"
Cohesion: 0.40
...
### Community 138 - "20260911153000_integracion_ucheck/migration.sql"
Cohesion: 0.83
Nodes (3): "campo_locales", "campo_visitas", "integracion_ucheck_eventos"

### Community 140 - "Prefer Statically Analyzable Paths"
Cohesion: 0.50
Nodes (3): File-System Paths, Import Paths, Prefer Statically Analyzable Paths

### Community 143 - "20260706131806_roles_visibilidad_y_locales/migration.sql"
Cohesion: 0.50
Nodes (3): "empresa_modulos", "empresa_paginas", "locales"

### Community 144 - "20260811190000_impulsadores_tareas_dirigidas/migration.sql"
Cohesion: 0.67
Nodes (3): "tareas_globales", "tareas_globales_usuario", "visitas"

### Community 145 - "20260908120000_roles_por_empresa/migration.sql"
Cohesion: 0.50
Nodes (3): roles, roles_empresa_mapa, roles_originales

### Community 146 - "web/README.md"
Cohesion: 0.50
Nodes (3): Deploy on Vercel, Getting Started, Learn More

### Community 148 - "Prefer Statically Analyzable Paths"
Cohesion: 0.50
Nodes (3): File-System Paths, Import Paths, Prefer Statically Analyzable Paths

### Community 150 - "Entornos local y producción"
Cohesion: 0.50
...
### Community 152 - "Scripts SQL para producción"
Cohesion: 0.50
...
### Community 326 - "hashPassword"
Cohesion: 0.80
Nodes (3): hashPassword(), scrypt, verifyPassword()

### Community 337 - ".gestionar"
Cohesion: 0.18
Nodes (4): CatalogoCampoService, Injectable, PlanificacionCampoService, Injectable

### Community 338 - "src/utils/ruc.ts"
Cohesion: 0.80
Nodes (4): calcularDvRucPy(), esRucParaguayoValido(), normalizarRucPy(), pistaRucPy()

### Community 339 - "AgendaUcheckDto"
Cohesion: 0.18
Nodes (7): AgendaUcheckDto, IsEmail, IsString, Matches, MaxLength, Injectable, UcheckIntegracionGuard

### Community 340 - "IntegracionesUcheckController"
Cohesion: 0.20
Nodes (7): IntegracionesUcheckController, Body, Controller, Get, Post, Query, UseGuards

### Community 341 - "AsignacionesService"
Cohesion: 0.25
Nodes (5): AsignacionesService, Injectable, AsignacionEmpresaDto, EmpresaModuloDto, PaginaAsignada

### Community 344 - "[pagina]/page.tsx"
Cohesion: 0.18
Nodes (10): AvisosPanel, ClientesPanel, JornadaPanel, LocalesPanel, NovedadesPanel, RutaImpulsadorPanel, SupervisionPanel, TareasImpulsadorPanel (+2 more)

### Community 345 - "CrearAvisoDto"
Cohesion: 0.20
Nodes (9): CrearAvisoDto, IsEnum, IsInt, IsOptional, IsString, MaxLength, Min, MinLength (+1 more)

### Community 346 - "EjecutablesService"
Cohesion: 0.38
Nodes (3): EjecutablesService, Injectable, EjecutableDto

### Community 347 - "ConsultaTareasCampoDto"
Cohesion: 0.33
Nodes (5): ConsultaTareasCampoDto, IsOptional, IsString, MaxLength, IsIn

### Community 348 - "env.schema.ts"
Cohesion: 0.33
Nodes (5): booleanFromString, Env, parseCorsOrigins(), rawEnvSchema, validateEnv()

### Community 349 - "IntegracionesUcheckService"
Cohesion: 0.48
Nodes (4): correoNormalizado(), fechaSql(), IntegracionesUcheckService, Injectable

### Community 350 - "ListarNotificacionesDto"
Cohesion: 0.40
Nodes (4): ListarNotificacionesDto, IsBoolean, IsOptional, Transform

### Community 351 - "SubirFotoTareaDto"
Cohesion: 0.67
Nodes (3): SubirFotoTareaDto, IsEnum, IsNotEmpty

## Knowledge Gaps
- **788 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+783 more)
...
- **Why does `PrismaService` connect `PrismaService` to `roles.service.ts`, `campo.module.ts`, `ModulosService`, `NotificacionService`, `admin-empresas.service.ts`, `ActualizarPaginaDto`, `usuarios.service.ts`, `foto.service.ts`, `auth.service.ts`, `plataforma.controller.ts`, `acceso-plataforma.service.ts`, `AuthService`, `ActualizarEjecutableDto`, `jornada-campo.service.ts`, `supervision.service.ts`, `HealthController`, `.gestionar`, `AsignacionesService`, `campo.controller.ts`, `EjecutablesService`, `IntegracionesUcheckService`, `ListarNotificacionesDto`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `useOperacionCampo()` connect `apiFetch` to `tareas-impulsador-panel.tsx`, `jornada-campo.service.ts`, `locales-panel.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@prisma/adapter-pg`, `@prisma/client`, `api/package.json`, `zod`, `pg`, `cookie-parser`, `@nestjs/jwt`, `reflect-metadata`, `@nestjs/platform-express`, `@nestjs/swagger`, `@nestjs/throttler`, `class-validator`, `jornada-campo.service.ts`?**
