# Graph Report - COMERCIA  (2026-09-23)

## Corpus Check
- 485 files · ~183,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2547 nodes · 4949 edges · 354 communities (159 shown, 195 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f8288f8`
...
- `ListarNovedadesDto` --inherits--> `PaginacionDto`  [EXTRACTED]
  apps/api/src/campo/dto/novedad.dto.ts → apps/api/src/common/utils/paginacion.ts

## Import Cycles
- None detected.

## Communities (354 total, 195 thin omitted)
...
### Community 5 - "acceso-plataforma.service.ts"
Cohesion: 0.27
...
Cohesion: 0.09
Nodes (37): InicioResumen(), ClientesPanel(), BotonesFormulario(), CabeceraCampo(), CampoTexto(), AgendaDelDia(), JornadaPanel(), ListadoVisitas() (+29 more)
...
Cohesion: 0.10
Nodes (33): SelectorUbicacion, MapaClientes(), MapaClientesProps, MapaLocal(), Props, SelectorClienteCombobox(), SelectorUbicacion(), IconoAlerta() (+25 more)
...
Cohesion: 0.07
Nodes (34): Tab, EmpresasAbmPanel(), FORM_INICIAL, FormEmpresa, FORM_INICIAL, RolesPanel(), SelectorFotosCampo(), TablaCampo() (+26 more)
...
### Community 24 - "rangoPaginacion"
Cohesion: 0.14
Nodes (6): CatalogoCampoService, Injectable, PlanificacionCampoService, Injectable, rangoPaginacion(), respuestaPaginada

### Community 25 - "apiFetch"
Cohesion: 0.15
Nodes (21): AvisosPanel(), AvisosPanelProps, itemsDeLista(), GaleriaAdjuntosCampo(), NovedadesPanel(), IconoCheck(), IconoContacto(), IconoMegafono() (+13 more)
...
Cohesion: 0.10
Nodes (26): ListChecksIcon(), NavigationIcon(), SupervisionPanel(), SupervisionPanelProps, TabType, UsersIcon(), CATEGORIAS_PRESET, TokenColor (+18 more)

### Community 30 - "campo.ts"
Cohesion: 0.08
Nodes (41): BadgeNotificaciones(), formatearHoraOFecha(), obtenerGrupoFecha(), PanelNotificaciones(), PanelNotificacionesProps, PanelComentarios(), PanelComentariosProps, SubidorFotos() (+33 more)

### Community 31 - "datos-usuario.ts"
Cohesion: 0.38
...
### Community 36 - "comentario.service.ts"
Cohesion: 0.17
Nodes (10): ComentarioTareaDto, CrearComentarioTareaDto, IsNotEmpty, IsString, MaxLength, ComentarioService, Injectable, esLiderDe() (+2 more)
...
### Community 40 - "prisma.service.ts"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (8): HealthController, ApiOperation, ApiTags, Controller, Get, PrismaService, Injectable, HealthCheck
...
### Community 50 - "PaginacionDto"
Cohesion: 0.11
Nodes (15): PaginacionDto, IsInt, IsOptional, Max, Min, Type, Get, Query (+7 more)
...
### Community 60 - "supervision.service.ts"
Cohesion: 0.17
Nodes (13): ColaboradorResumenItem, ConsultaSupervisionDto, SupervisionResumenDto, IsDateString, IsOptional, Matches, ParadaRuta, SupervisionService (+5 more)
...
### Community 78 - "JornadaCampoService"
Cohesion: 0.18
Nodes (5): JornadaCampoService, Injectable, comprobarMarcaEnLocal(), aRadianes(), distanciaMetros()
...
### Community 86 - ".agenda"
Cohesion: 0.53
Nodes (4): prisma, condicionAgenda(), condicionHorario(), prisma
...
Cohesion: 0.21
Nodes (7): FotosTareaResponseDto, FotoTareaDto, MomentoFotoDto, FotoService, Injectable, prepararEvidencia(), tareaParaEvidencia()
...
### Community 104 - "ruta-impulsador-panel.tsx"
Cohesion: 0.24
Nodes (13): LocalParaNovedad, RutaImpulsadorPanel(), formatoDistancia(), metrosEntre(), mensajeError(), queryFechasCampo(), CoordenadaCampo, minutosDeHora() (+5 more)

### Community 105 - "novedad.service.ts"
Cohesion: 0.27
Nodes (12): ActualizarEstadoNovedadDto, CrearNovedadDto, ListarNovedadesDto, IsEnum, IsInt, IsOptional, IsString, MaxLength (+4 more)
...
### Community 227 - "multer-config.ts"
Cohesion: 0.32
Nodes (6): ALLOWED_MIME_TYPES, filtroImagen(), multerConfigAdjuntosCampo, multerConfigFotosTareas, multerConfigLogoCliente, validarArchivoImagen()

### Community 228 - "env.schema.ts"
Cohesion: 0.33
...
Cohesion: 0.32
Nodes (8): FilaAgendaId, ReglaHorario, TotalAgenda, ocurreHorario(), ocurreHorarioEnRango(), regla, validarHorario(), vigenciaCampo()
...
## Knowledge Gaps
- **801 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+796 more)
...
- **Why does `PrismaService` connect `PrismaService` to `roles.service.ts`, `RequestConUsuario`, `campo.module.ts`, `MarcacionUcheckDto`, `ModulosService`, `acceso-plataforma.service.ts`, `usuarios.service.ts`, `aviso.service.ts`, `rangoPaginacion`, `AsignarModuloDto`, `comentario.service.ts`, `prisma.service.ts`, `auth.service.ts`, `ucheck-sso.service.ts`, `PaginacionDto`, `mi-plataforma.service.ts`, `plataforma.controller.ts`, `supervision.service.ts`, `adjunto-campo.service.ts`, `NotificacionService`, `JornadaCampoService`, `admin-empresas.service.ts`, `.agenda`, `auth.controller.ts`, `jornada-campo.service.ts`, `foto.service.ts`, `novedad.service.ts`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `useOperacionCampo()` connect `jornada-panel.tsx` to `JornadaCampoService`, `supervision-panel.tsx`, `locales-panel.tsx`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `prisma` connect `.agenda` to `dependencies`?**
...
- **Should `RequestConUsuario` be split into smaller, more focused modules?**
  _Cohesion score 0.06205121257282211 - nodes in this community are weakly interconnected._
